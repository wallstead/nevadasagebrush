...
class Vw_widget_social_subscription extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( $twitter ) {
			...
			?>
				<div class="social-subscription">
					<a class="social-subscription-icon" href="<?php echo esc_attr( $twitter_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Follow our twitter', 'envirra' ) ?>"><i class="icon-social-twitter"></i></a>
		...
		if ( $facebook ) {
			...
			?>
				<div class="social-subscription">
					<a class="social-subscription-icon" href="<?php echo esc_attr( $facebook_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Like our facebook', 'envirra' ) ?>"><i class="icon-social-facebook"></i></a>
					<div class="social-subscription-counter">
		...
		if ( $youtube ) {
			...
			?>
				<div class="social-subscription">
					<a class="social-subscription-icon" href="<?php echo esc_attr( $youtube_count['page_url'] ); ?>" title="<?php esc_attr_e( 'Subscribe our youtube', 'envirra' ) ?>"><i class="icon-social-youtube"></i></a>
					<div class="social-subscription-counter">
		...
		if ( $googleplus ) {
			...
			?>
				<div class="social-subscription">
					<a class="social-subscription-icon" href="<?php echo esc_attr( $googleplus_count['page_url'] ); ?>" title="<?php esc_attr_e( '+1 our page', 'envirra' ) ?>"><i class="icon-social-gplus"></i></a>
					<div class="social-subscription-counter">
