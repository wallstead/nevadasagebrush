;(function( $, window, document, undefined ){
	...
	var INSTANT_SEARCH = {
		...
		delay_search: null,
		keywords: '',
		form_template: '<form class="instant-search-panel" method="get"> <input type="text" id="s" name="s" value="" aria-label="search" role="search" placeholder="Search"> <i class="loading-icon icon-symbol-spin3 animate-spin hidden"></i> <ul class="result-panel"></ul> </form>',
		defaults: {
			search_delay: 350,
		},
