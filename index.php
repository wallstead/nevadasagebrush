				...
				<div class="featuredSlider owl-carousel">
					<?php
						...
						foreach($custom_posts as $post) : setup_postdata($post);
								...
								echo '<a href="'.echo esc_url( get_permalink($post->ID) ).'"><div class="featuredStory animated fadeIn" style="background-image: url('.get_the_post_thumbnail_url($post->ID, 'post-thumbnail' ).');" data-title="'.get_the_title($post->ID).'">';
